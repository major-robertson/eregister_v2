...
class LienFiling extends Model implements HasMedia
{
    ...
    public function allowedTransitions(): array
    {
        return match ($this->status) {
            ...
            FilingStatus::Paid => [FilingStatus::InFulfillment, FilingStatus::AwaitingClient, FilingStatus::AwaitingEsign, FilingStatus::AwaitingNotary, FilingStatus::Complete],
            FilingStatus::AwaitingClient => [FilingStatus::Draft, FilingStatus::AwaitingPayment, FilingStatus::Paid, FilingStatus::AwaitingEsign, FilingStatus::AwaitingNotary, FilingStatus::InFulfillment, FilingStatus::Mailed, FilingStatus::Recorded, FilingStatus::Complete, FilingStatus::Canceled],
            FilingStatus::AwaitingEsign => [FilingStatus::Draft, FilingStatus::AwaitingPayment, FilingStatus::Paid, FilingStatus::AwaitingClient, FilingStatus::AwaitingNotary, FilingStatus::InFulfillment, FilingStatus::Mailed, FilingStatus::Recorded, FilingStatus::Complete, FilingStatus::Canceled],
            FilingStatus::AwaitingNotary => [FilingStatus::Draft, FilingStatus::AwaitingPayment, FilingStatus::Paid, FilingStatus::AwaitingClient, FilingStatus::AwaitingEsign, FilingStatus::InFulfillment, FilingStatus::Mailed, FilingStatus::Recorded, FilingStatus::Complete, FilingStatus::Canceled],
            FilingStatus::InFulfillment => [FilingStatus::Mailed, FilingStatus::AwaitingClient, FilingStatus::AwaitingEsign, FilingStatus::AwaitingNotary, FilingStatus::Canceled],

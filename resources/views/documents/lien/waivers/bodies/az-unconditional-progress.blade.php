{{--
    Arizona statutory form: Unconditional Waiver and Release on Progress
    Payment, A.R.S. § 33-1008(D)(2). Statutory text reproduced verbatim
    ...
    .waiver-notice box renders 12pt bold caps, satisfying the rule. Do NOT add
    a notary block or extra terms.
--}}
<div class="waiver-title">{{ $waiver['form']['title'] }}</div>
<div class="waiver-statute">Arizona Revised Statutes § 33-1008(D)(2)</div>
...
<div class="waiver-body">
    <p>
        ...
        $<span class="fill">{{ $waiver['amount'] ?? '' }}</span>
        ...
        has on the above referenced project to the following extent. This release covers a progress payment
...
<p class="waiver-foot">
    Statutory form under A.R.S. § 33-1008(D)(2) (substantial compliance). Notarization and witnessing are
    not required. Form LW-AZ-UP v{{ $waiver['form']['template_version'] }}.
</p>

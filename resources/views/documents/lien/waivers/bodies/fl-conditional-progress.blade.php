{{--
    Florida conditional progress waiver: the Fla. Stat. § 713.20(4)
    safe-harbor form (reproduced verbatim, including its retention/after-date
    exclusion sentence) PLUS the lienor-elected condition permitted by
...
<div class="waiver-statute">State of Florida: Fla. Stat. &sect; 713.20(4) form, conditioned as permitted by &sect; 713.20(7)</div>
...
<p class="waiver-foot">
    Fla. Stat. &sect; 713.20(4) safe-harbor form with the check-payment condition the lienor may elect
    under &sect; 713.20(7); enforceable in accordance with its terms (&sect; 713.20(8)). No notarization
    or witness is required. This waiver does not release payment-bond rights (bond waivers use the
    separate forms in Fla. Stat. &sect; 713.235 and &sect; 255.05(2)).
    Form LW-FL-CP v{{ $waiver['form']['template_version'] }}.
</p>

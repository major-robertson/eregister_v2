{{--
    ...
    Final Payment, Fla. Stat. § 713.20(5) ("the waiver and release may be in
    substantially the following form"). Statutory text reproduced verbatim
    with only the blanks bound to payload fields. UNCONDITIONAL on its face
    and (unlike the progress form) it has NO retention carve-out: signing
    waives the lien for everything furnished, including retainage. No
    notarization or witness is required.
--}}
<div class="waiver-title">{{ $waiver['form']['title'] }}</div>
<div class="waiver-statute">State of Florida: Statutory form, Fla. Stat. &sect; 713.20(5)</div>
...
<p class="waiver-foot">
    Statutory safe-harbor form per Fla. Stat. &sect; 713.20(5) (substantial similarity). No notarization
    or witness is required. This final waiver has no retention carve-out and is unconditional on its
    face; it does not release payment-bond rights (bond waivers use the separate forms in
    Fla. Stat. &sect; 713.235 and &sect; 255.05(2)). Form LW-FL-UF v{{ $waiver['form']['template_version'] }}.
</p>

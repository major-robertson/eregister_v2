{{--
    ...
    Rights Upon Final Payment, O.C.G.A. § 44-14-366(e) (SB 315, eff.
    1/1/2021; text verified against the enrolled bill). Identical to the
    interim form except the operative paragraph: no through-date and no
    retention exception: the release covers all liens, claims of liens, and
    labor/material bond rights for labor or materials furnished to or on
    account of the contractor for the property. "Substantially follow"
    standard; whole waiver in at least 12 point font (statutory passages set
    at 12pt, the shell's maximum). Executed under hand and seal before a
    witness (no notary); e-sign disabled for GA. The NOTICE paragraph is
    mandatory: omitting it renders the form unenforceable and invalid.
    Per § 44-14-366(g) the waiver conclusively becomes effective on the
    earliest of actual receipt of the funds, a separate written
    acknowledgment of payment in full, or 90 days after execution unless an
    Affidavit of Nonpayment is timely filed.
--}}
<div class="waiver-title">{{ $waiver['form']['title'] }}</div>
<div class="waiver-statute">State of Georgia: Statutory form, O.C.G.A. &sect; 44-14-366(e)</div>
...
<div class="waiver-body" style="font-size: 12pt; line-height: 1.4;">
    ...
    <p>
        ...
        ON ACCOUNT OF LABOR OR MATERIALS, OR BOTH, FURNISHED BY THE UNDERSIGNED TO OR ON ACCOUNT OF
...
<p class="waiver-foot">
    Statutory form per O.C.G.A. &sect; 44-14-366(e), substantially following the prescribed language in
    ...
    Affidavit of Nonpayment is timely filed. Form LW-GA-FP v{{ $waiver['form']['template_version'] }}.
</p>

{{--
    Michigan statutory form: PARTIAL CONDITIONAL WAIVER, MCL 570.1115(9)(b).
    Identical to the partial unconditional form plus the statutory sentence
    "This waiver is conditioned on actual payment of the amount shown above."
    Effective upon payment of the amount indicated (MCL 570.1115(4)). The
    "(circle one) does / does not" election is circled by hand. No notary or
    witness block: adding one alters the statutory format.
--}}
@php
...
<div class="waiver-title">Partial Conditional Waiver</div>
<div class="waiver-statute">Michigan Construction Lien Act: MCL 570.1115(9)(b)</div>
...
<div class="waiver-body">
    ...
    <p>
        ...
        above. <strong>This waiver is conditioned on actual payment of the amount shown above.</strong>
    </p>
    <p>
...
<p class="waiver-foot">
    Michigan statutory form, MCL 570.1115(9)(b) (used in substantially the statutory format);
    effective upon payment of the amount indicated (MCL 570.1115(4)).
    Form LW-MI-PC v{{ $waiver['form']['template_version'] }}.
</p>

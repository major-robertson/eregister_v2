{{--
    Texas statutory form: Conditional Waiver and Release on Progress Payment,
    Tex. Prop. Code § 53.284(b). A waiver is unenforceable unless it
...
<div class="waiver-statute">State of Texas: Statutory form, Tex. Prop. Code &sect; 53.284(b)</div>
...
<p class="waiver-foot">
    Statutory form per Tex. Prop. Code &sect; 53.284(b); substantial compliance required by
    &sect;&sect; 53.281(b), 53.284(a). A conditional release is effective only if evidence of payment to
    the claimant exists (&sect; 53.281(b)(3)). Form LW-TX-CP v{{ $waiver['form']['template_version'] }}.
</p>

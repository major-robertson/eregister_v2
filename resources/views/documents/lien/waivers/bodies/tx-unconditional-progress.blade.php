{{--
    Texas statutory form: Unconditional Waiver and Release on Progress
    Payment, Tex. Prop. Code § 53.284(c). The § 53.284(c)(1) notice MUST appear
    at the top of the document, printed in bold type at least as large as the
    largest type used in the document and not smaller than 10-point, so the
    notice box renders FIRST (12pt bold, equal to the shell's largest type),
    in the statute's own sentence case (Texas prescribes bold, not caps).
    § 53.283: it is prohibited to require this form unless the claimant was
    actually paid in good and sufficient funds.
--}}
...
<div class="waiver-statute">State of Texas: Statutory form, Tex. Prop. Code &sect; 53.284(c)</div>
...
<div class="waiver-body">
    <p>
        ...
        $<span class="fill">{{ $waiver['amount'] ?? '' }}</span> for all labor, services, equipment, or
        ...
        payment rights for persons in the signer's position that the signer has on the above referenced
...
<p class="waiver-foot">
    Statutory form per Tex. Prop. Code &sect; 53.284(c); substantial compliance required by
    ...
    Form LW-TX-UP v{{ $waiver['form']['template_version'] }}.
</p>

...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <flux:button
                :href="route('admin.formations.board')"
                variant="subtle"
                icon="arrow-left"
                size="sm"
                wire:navigate
            ...
            <div class="mt-1 flex flex-wrap items-center gap-2">
                ...
                @endif
                <flux:badge size="sm" color="indigo">{{ $state->state_code }}</flux:badge>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            {{-- State-specific answers for this formation (usually none for LLC). --}}

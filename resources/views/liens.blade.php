...
@section('title', 'Mechanics Lien Filing Services | File a Construction Lien on Property')

@section('meta')
<meta name="description" content="File a mechanics lien on property with our trusted construction lien filing services. Expert mechanics lien filing for contractors, subcontractors & suppliers. File a construction lien in all 50 states.">
<meta name="keywords" content="mechanics lien filing, file construction lien, mechanics lien on property, file a mechanics lien, contractor lien on property, file a construction lien, construction lien filing, construction lien services">
@endsection
    ...
    <section class="relative overflow-hidden bg-gradient-to-b from-zinc-900 via-zinc-900 to-zinc-800 py-24 lg:py-32">
        ...
        <div class="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-6 max-w-2xl text-lg text-zinc-400 sm:text-xl">
                File a mechanics lien on property with confidence. Our construction lien filing services help contractors, subcontractors, and suppliers protect their payment rights with state-compliant forms.
            </p>
                ...
                <div class="grid gap-6 bg-zinc-50/50 p-6 lg:grid-cols-3">
                    ...
                    <div class="space-y-3">
                        <div class="rounded-xl bg-white p-4 shadow-sm">
                            <div class="text-xs font-medium uppercase tracking-wider text-zinc-400">Active Mechanics Liens</div>
                        ...
                        <div class="rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 p-4 text-white shadow-sm">
                            <div class="text-xs font-medium uppercase tracking-wider text-amber-100">Construction Lien Deadline</div>
            ...
            <div class="grid gap-12 lg:grid-cols-2 lg:gap-16">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div class="group">
                        ...
                        <p class="mt-1 text-sm text-zinc-600">Our team reviews and prepares your mechanics lien filing documents</p>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <p class="mt-1 text-sm text-zinc-600">Never miss a construction lien filing deadline with smart reminders</p>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <p class="mt-1 text-sm text-zinc-600">Contractor lien on property forms updated to match current laws</p>
                    </div>
    ...
    <section id="services" class="border-y border-zinc-200 bg-zinc-50 py-24">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-3 text-zinc-600">File a construction lien or any related document in minutes with our mechanics lien filing platform</p>
            </div>
            ...
            <div class="relative mt-16">
                ...
                <div class="grid gap-8 lg:grid-cols-3">
                    <div class="relative text-center">
                        ...
                        <p class="mt-2 text-zinc-600">Provide the property address, owner info, and amount owed for your mechanics lien on property. Takes 2 minutes.</p>
                    </div>
                    ...
                    <div class="relative text-center">
                        ...
                        <p class="mt-2 text-zinc-600">We automatically use the correct construction lien filing form for your state's specific requirements.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-zinc-600">Receive your documents within 1-3 business days, or let us handle everything and file your contractor lien on property for you.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-6">
                    ...
                    <p class="mt-2 text-zinc-600">File a contractor lien on property when clients don't pay for completed construction work.</p>
                </div>
                ...
                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-6">
                    ...
                    <p class="mt-2 text-zinc-600">File a construction lien to secure payment even when working under a general contractor.</p>
                </div>
                ...
                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-6">
                    ...
                    <p class="mt-2 text-zinc-600">Use mechanics lien filing to protect payment for materials supplied to construction projects.</p>
                </div>

                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-6">
                    <div class="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-violet-100 text-violet-600">
                    ...
                    <p class="mt-2 text-zinc-600">File a mechanics lien on property for unpaid equipment rentals used on construction sites.</p>
                </div>

                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-6">
                    <div class="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-rose-100 text-rose-600">
                    ...
                    <p class="mt-2 text-zinc-600">Construction lien filing services for design professionals owed for plans and specifications.</p>
                </div>

                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-6">
                    <div class="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-cyan-100 text-cyan-600">
                    ...
                    <p class="mt-2 text-zinc-600">Workers can file a mechanics lien for unpaid wages on construction projects.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-800 py-20">
            <div class="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
                ...
                <p class="mt-4 text-lg text-zinc-400">
                    Use our construction lien filing services to protect your payment rights. File a mechanics lien on property in under 5 minutes.
                </p>
                <div class="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                    <a href="{{ route('register') }}" class="inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 font-semibold text-zinc-900 shadow-lg transition hover:scale-105 hover:bg-zinc-50 hover:shadow-xl">
                        File a Construction Lien Now
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                    </a>
                </div>
                <p class="mt-6 text-sm text-zinc-500">No credit card required. Trusted by 10,000+ contractors and suppliers.</p>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-8 lg:grid-cols-3">
                <div class="rounded-2xl border border-zinc-200 bg-zinc-50 p-8 text-center">
                    <div class="mx-auto mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-amber-100 text-amber-600">
                ...
                <div class="rounded-2xl border border-zinc-200 bg-zinc-50 p-8 text-center">
                    <div class="mx-auto mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">
            ...
            <div class="mt-12 rounded-2xl bg-zinc-900 p-8 text-center lg:p-12">
                <p class="text-lg text-zinc-300">
                    Don't let unpaid invoices hurt your business. <span class="font-semibold text-white">File a mechanics lien today</span> and secure the payment you've earned. Our platform helps you file a contractor lien on property quickly and correctly.
                </p>
                <a href="{{ route('register') }}" class="mt-6 inline-flex items-center gap-2 rounded-full bg-amber-500 px-8 py-4 font-semibold text-zinc-900 shadow-lg transition hover:scale-105 hover:bg-amber-400 hover:shadow-xl">

    ...
    <x-ui.card>
        ...
        @else
            <flux:table :paginate="$projects">
                <flux:table.columns>
                    <flux:table.column class="cursor-pointer" wire:click="sortBy('name')">
                        Project Name
                        @if($sortField === 'name')
                    ...
                    <flux:table.column>Next Deadline</flux:table.column>
                    <flux:table.column class="cursor-pointer" wire:click="sortBy('created_at')">
                        Created

...
<head>
    @include('partials.head', ['title' => 'State of Florida — Public Information Website (Demo 1)'])
...
<body class="min-h-screen bg-white font-sans text-slate-900 antialiased"
        ...
        <div class="mx-auto flex max-w-7xl flex-col items-start justify-between gap-2 px-4 py-2 text-xs sm:flex-row sm:items-center sm:px-6 lg:px-8">
            <div class="flex items-center gap-2">
                ...
                <span>
                    ...
                    <span class="ml-1 font-semibold text-amber-400">Demo 1</span>
                </span>
            </div>
            <div class="flex flex-wrap items-center gap-x-5 gap-y-2">
                <a href="{{ route('government.florida-eog-demo-2') }}"
    ...
    <section class="bg-slate-50 py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
                ...
                <div class="aspect-[4/3] w-full overflow-hidden rounded-xl border border-slate-200 bg-slate-100">
    ...
    <section class="bg-white py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-6 lg:grid-cols-3">
                @php
                    $news = [
                        ['date' => 'May 5, 2026', 'tag' => 'Announcement', 'title' => 'New public information resources available statewide', 'image' => '/img/demos/florida-eog/news-1.jpg'],
                        ['date' => 'April 28, 2026', 'tag' => 'Program Update', 'title' => 'Updated program eligibility guidance for Florida residents', 'image' => '/img/demos/florida-eog/news-2.jpg'],
                        ['date' => 'April 14, 2026', 'tag' => 'Notice', 'title' => 'Office hours and contact information for the upcoming season', 'image' => '/img/demos/florida-eog/news-3.jpg'],
                    ];
                @endphp
                ...
                @foreach ($news as $article)
                    <article class="group flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition hover:shadow-md">
                        {{-- Photo placeholder: upload to public{{ $article['image'] }} --}}
                        <button type="button" @click="showPage('News article')"
                            class="block aspect-[16/9] w-full overflow-hidden bg-slate-100">
    ...
    <div x-show="modalOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center px-4"
        ...
        <div x-show="modalOpen" x-cloak x-transition.opacity
            ...
            class="absolute inset-0 bg-slate-900/70"></div>

    ...
    <div class="mx-auto max-w-lg space-y-6 px-6 py-10">
        <x-ui.card>
            <div
                ...
                x-data="salesTaxPaymentPoller(@js(route('sales-tax.api.registrations.payment-status', $application)), @js(route('sales-tax.registrations.payment-confirmation', array_filter(['application' => $application, 'payment_intent' => request('payment_intent')]))), @js(route('sales-tax.registrations.checkout', $application)))"
                x-init="startPolling()"
            >

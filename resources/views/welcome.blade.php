    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-lg">Welcome to eRegister</h1>
                <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">Your trusted platform for business registration and
